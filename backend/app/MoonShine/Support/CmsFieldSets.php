            ...
            'main' => [
                ...
                Select::make('Тип страницы', 'template')
                    ->options([
                        ...
                        'content' => 'Страница с блоками',
                        'legal' => 'Юридическая страница',
                        'about' => 'Специальная страница "О нас"',
                        'blog' => 'Специальная страница блога',
                    ])
                    ->default('text')
                    ->hint('Для самостоятельного создания выбирайте обычную текстовую страницу. Остальные типы нужны для специальных разделов сайта.'),
