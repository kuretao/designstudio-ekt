      ...
      <header className="fixed left-0 right-0 top-0 z-50 px-5 py-4 md:px-10 lg:px-16">
        ...
        <div className="nav-item mx-auto flex max-w-[1600px] items-center justify-between gap-4 rounded-full border border-white/10 bg-[#0d0d0b]/70 px-5 py-3 text-white shadow-[0_18px_70px_rgba(0,0,0,0.28)] backdrop-blur-xl">
          ...
          <button
            ...
            className="group hidden cursor-pointer items-center gap-2 rounded-full border border-[#d7c4a1]/35 px-5 py-2.5 text-[10px] uppercase tracking-[0.22em] text-[#d7c4a1] transition-all duration-300 hover:border-[#d7c4a1] hover:bg-[#d7c4a1] hover:text-[#0d0d0b] hover:shadow-[0_0_32px_rgba(215,196,161,0.28)] md:flex"
          >
