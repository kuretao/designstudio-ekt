      ...
      <ul className="mt-5 space-y-3">
        {block.items?.map((item, i) => (
          <li key={i} className="flex gap-4 leading-relaxed text-[#D6D1CA]">
            <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-[#C58351]" />
            {item}
          </li>
        ))}
      </ul>
      ...
      <section className="relative flex min-h-[70vh] items-end overflow-hidden px-5 pb-16 md:px-10 lg:px-16">
        ...
        <div className="relative z-10 mx-auto w-full max-w-5xl">
          <div className="mb-6 flex flex-wrap items-center gap-4">
            <span className="rounded-full border border-[#C58351]/45 bg-[#050505]/50 px-4 py-1.5 text-[10px] uppercase tracking-[0.3em] text-[#C58351] backdrop-blur">
              {article.category}
            </span>
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_280px] lg:items-start">
            ...
            <div>
              ...
              <div className="mt-16 border-t border-white/10 pt-8">
                <Link
                  href="/novosti"
                  className="inline-flex items-center gap-3 text-sm uppercase tracking-[0.22em] text-[#C58351] transition hover:gap-5"
                >
                  ← Все новости
                </Link>
              </div>
            ...
            <aside className="space-y-4 lg:sticky lg:top-32">
              <GlassPanel className="rounded-[1.75rem] p-6">
                <p className="mb-4 text-xs uppercase tracking-[0.3em] text-[#C58351]">Об авторе</p>
              ...
              <GlassPanel className="rounded-[1.75rem] p-6">
                <p className="mb-4 text-xs uppercase tracking-[0.3em] text-[#C58351]">Обсудить проект</p>
                <p className="mb-5 text-sm leading-relaxed text-[#D6D1CA]">
                  Есть идея или вопрос? Свяжитесь с нами — ответим в течение рабочего дня.
                </p>
                <Link
                  href="/kontakty"
                  className="inline-flex w-full items-center justify-center rounded-full bg-[#C58351] px-5 py-3 text-xs uppercase tracking-[0.22em] text-[#050505] transition hover:bg-[#F5F2EC]"
                >
                  Написать нам
                </Link>
              </GlassPanel>
      ...
      {related.length > 0 && (
        <section className="border-t border-white/10 px-5 py-20 md:px-10 lg:px-16">
          <div className="mx-auto max-w-7xl">
            <p className="mb-3 text-xs uppercase tracking-[0.45em] text-[#C58351]">Читать также</p>
              ...
              {related.map((a) => (
                ...
                >
                  <div className="relative h-52 overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#050505]/80 via-transparent to-[#C58351]/10" />
                    <span className="absolute left-4 top-4 rounded-full border border-[#C58351]/35 bg-[#050505]/60 px-3 py-1 text-[10px] uppercase tracking-[0.22em] text-[#C58351] backdrop-blur">
                      {a.category}
                    </span>
                  </div>
                  <div className="p-5">
